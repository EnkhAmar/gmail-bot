...
if driver.find_element(By.CLASS_NAME, "aQH") == True:
    ...
    chainer = actions_chain_for_hovering_on_attachments.move_to_element(first_attachment)
    chainer.perform()
    download_btn = first_attachment.find_elements(By.CLASS_NAME, "aSK J-J5-Ji aYr")
...
print("This is the message from ", "and the title is ", gmail_title, "this is the message:\n", message_of_the_gmail, "the attachments are in the folder that is named: attachment-folder(which is in this directory:",  save_dir, ")")
